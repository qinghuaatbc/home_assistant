...
export default function EditPanel({
  ...
  return (
    <div className="fp-edit-panel" style={{
      ...
      display: 'flex', flexDirection: 'column', maxHeight: '60vh', fontSize: 11,
    }}>
      ...
      <div style={{ padding: '8px 10px', borderTop: '1px solid var(--sep)', background: 'var(--card)' }}>
        <button className="btn btn-accent" style={{ width: '100%', fontSize: 11, padding: '6px 10px' }}
